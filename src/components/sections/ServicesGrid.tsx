                    ...
                    {services.map((service, i) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`relative group flex flex-col p-8 rounded-2xl border text-center transition-all duration-500 ${service.highlighted
                            ...
                            >
                                ...
                                <div className="flex justify-center mb-5">
                                    <Icon
                                        size={44}
                                        className={`transition-all duration-500 ${service.highlighted
