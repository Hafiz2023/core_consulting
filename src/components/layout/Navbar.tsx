...
import TopBar from "./TopBar"; // Updated import
...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <nav className="sticky top-0 left-0 w-full z-40 bg-white shadow-sm">
                <div className="container mx-auto flex justify-between items-center px-4 py-3 md:py-4">
                    ...
                    <div className="hidden lg:flex items-center space-x-6 text-gray-700 font-medium text-sm xl:text-base">
                        ...
                        <div className="flex space-x-3 ml-4">
                            ...
                            <Link
                                href="/login"
                                className="px-4 py-2 text-sm bg-blue-600 text-white rounded-md shadow hover:bg-blue-700 transition flex items-center"
                            >
                                Login
                            </Link>
                        </div>
