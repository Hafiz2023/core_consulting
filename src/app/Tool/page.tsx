    ...
    <div className="container mx-auto px-4 py-8 md:px-8 lg:px-16 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <strong>Business Continuity and Risk Management Tools</strong> that
          empower organizations to automate, monitor, and manage their
          resilience programs effectively. These tools integrate global best
          practices with modern technology, enabling real-time decision-making,
