    ...
    <div className="container mx-auto px-4 py-8 md:px-8 lg:px-16 max-w-4xl">
      ...
      <section>
        ...
        <p className="text-gray-700 leading-relaxed">
          ...
          <strong>
            banking, telecom, government, healthcare, energy, and manufacturing
          </strong>{" "}
          sectors. By combining automation and resilience strategies, we help
          enterprises minimize risks and achieve operational excellence even
          during crises.
        </p>
      </section>
    </div>
